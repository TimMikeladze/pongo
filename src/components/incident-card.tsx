...
import type { Incident, IncidentStatus, IncidentSeverity, Monitor } from "@/lib/types"
...
export function IncidentCard({ incident, monitors, showUpdates = true }: IncidentCardProps) {
