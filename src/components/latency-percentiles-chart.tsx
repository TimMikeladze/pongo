...
export function LatencyPercentilesChart({ results, height = 120 }: LatencyPercentilesChartProps) {
  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <LineChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
        ...
        />
        <Legend wrapperStyle={{ fontSize: "9px", fontFamily: "monospace" }} iconType="line" iconSize={8} />
        <Line type="monotone" dataKey="p50" stroke={colors.p50} strokeWidth={1.5} dot={false} name="p50" />
