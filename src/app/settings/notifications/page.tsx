    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="border border-dashed border-border rounded bg-card p-4 mb-6">
        ...
        <p className="text-[10px] text-muted-foreground mt-2">
          <span className="text-primary">note:</span> notification configuration not yet implemented. this feature will be added in a future update.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-16 border border-dashed border-border rounded">
        ...
        <p className="text-xs text-muted-foreground mb-1">no channels configured</p>
        <p className="text-[10px] text-muted-foreground">notification management coming soon</p>
      </div>
    </div>
  )
}
