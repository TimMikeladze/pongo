...
export function StatusDistributionChart({ results, height = 120 }: StatusDistributionChartProps) {
      ...
      <div className="flex flex-col gap-2 text-[10px] font-mono">
        {chartData.map((d) => (
          <div key={d.name} className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: getColor(d.name) }} />
